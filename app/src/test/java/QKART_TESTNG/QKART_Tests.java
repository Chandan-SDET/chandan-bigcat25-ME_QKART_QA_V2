...
public class QKART_Tests {
     ...
     */
         ...
         @Parameters({"USN" , "PWD"})
         public void TestCase01( String USN,  String PWD) throws InterruptedException {
        Boolean status;
        ...
        System.out.println(USN +""+ PWD);
         status = registration.registerUser(USN, PWD, true);
    ...
    @Parameters({"USN" , "PWD"})
    public void TestCase02( String USN,  String PWD) throws InterruptedException {
        Boolean status;
        ...
        registration.navigateToRegisterPage();
        status = registration.registerUser(USN, PWD, true);
        Assert.assertTrue("The registration failed",status);
    ...
    public void TestCase03(@Optional("YONEX") String product) throws InterruptedException {
        ...
        soft.assertTrue(status, "Test Case Failure. Unable to search for given product");
        ...
        //     return false;
        // }
        soft.assertTrue(searchResults.size() == 0, "Test Case Failure. There were no results for the given search string");
        ...
        for (WebElement webElement : searchResults) {
            ...
            //     return false;
            // }
            soft.assertTrue(elementText.toUpperCase().contains("YONEX"),"Test Case Failure. Test Results contains un-expected values");
        ...
        soft.assertTrue(status,"Test Case Failure. Invalid keyword returned results");
        // if (!status) {
        ...
        if (searchResults.size() == 0) {
            ...
            // return false;
            soft.assertTrue(searchResults.size() == 0,"Test Case Fail. Expected: no results , actual: Results were available");
        }
    ...
    @Parameters("product")
    public void TestCase04(@Optional("YONEX") String product) throws InterruptedException {
        ...
        for (WebElement webElement : searchResults) {
            ...
            if (result.verifySizeChartExists()) {
                ...
                if (result.openSizechart()) {
                    ...
                    Assert.assertTrue("Test Case Fail. Failure to open Size Chart",result.openSizechart());
                ...
                // return false;
                Assert.assertTrue("Test Case Fail. Size Chart Link does not exist",result.verifySizeChartExists());
            }
        }
    ...
    @Parameters({"Prod1","Prod2","Addr"})
    public void TestCase05(@Optional("YONEX")String Prod1,@Optional("Tan")String Prod2,@Optional("Addr line 1 addr Line 2 addr line 3")String Addr) throws InterruptedException {
        Boolean status;
    ...
    public void TestCase06(@Optional("Xtend")String Prod1,@Optional("Yarine")String Prod2) throws InterruptedException {
        Boolean status;
        ...
        try {
            ...
            //return false;
            Assert.assertTrue("Error while placing order in: ", status);
    ...
    @Parameters({"Prod1","QTY"})
    public void TestCase07(@Optional("Stylecon")String Prod1,@Optional("10") int QTY) throws InterruptedException {
        Boolean status;
        ...
        //         status ? "PASS" : "FAIL");
                ...
                Assert.assertTrue("The insufficient balance error is not thrown when the wallet balance is not enough:", status);
    ...
    public void TestCase08() throws InterruptedException {
       ...
       // takeScreenshot(driver, "StartTestCase", "TestCase09");
        ...
        Assert.assertTrue("Cart content not correct", status);
        ...
        "Test Case 8: Verify that product added to cart is available when a new tab is opened",
        status ? "PASS" : "FAIL");
        Assert.assertTrue("the product added to cart is not available when a new tab is opened", status);
    ...
    public void TestCase09() throws InterruptedException {
        ...
        //             status ? "PASS" : "FAIL");
        // }
        Assert.assertTrue("Verifying parent page url didn't change on privacy policy link click failed", status);
        ...
        Assert.assertTrue("Verifying new tab opened has Privacy Policy page heading failed ", status);
        ...
        Assert.assertTrue("Verifying new tab opened has Terms Of Service page heading failed ", status);
    ...
    @Parameters({"USN","Email","Testing the contact page"})
    public void TestCase10(@Optional("crio user")String USN, @Optional("criouser@gmail.com")String Email, @Optional("Testing the contact us page")String msg) throws InterruptedException {
        // logStatus("Start TestCase",
    ...
    @Parameters({"Prod","Addr"})
    public void TestCase11(@Optional("YONEX Smash Badminton Racquet")String USN, @Optional("Addr line 1  addr Line 2  addr line 3")String Addr) throws InterruptedException {
        Boolean status = false;
        logStatus("Start TestCase",
        ...
        //         "Test Case 11:  Ensure that the links on the QKART advertisement are clickable",
        //         status ? "PASS" : "FAIL");
                Assert.assertTrue(" the links on the QKART advertisement are not clickable", status);
       // return status;
    }
