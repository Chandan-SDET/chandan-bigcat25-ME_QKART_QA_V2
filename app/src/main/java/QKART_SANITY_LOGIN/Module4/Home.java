...
public class Home {
    ...
    public Boolean searchForProduct(String product) {
        try {
            ...
            WebDriverWait wait = new WebDriverWait(driver,30);
            wait.until(ExpectedConditions.or(ExpectedConditions.presenceOfElementLocated(By.xpath("//p[@class='MuiTypography-root MuiTypography-body1 css-yg30e6']")),
            ExpectedConditions.presenceOfElementLocated(By.xpath("//h4[text()=' No products found ']"))));
            Thread.sleep(3000);
            // WebElement search= driver.findElement(By.xpath("//h4[text()=' No products found ']"));
    ...
    public List<WebElement> getSearchResults() {
        ...
        try {
            ...
            // search results
            searchResults = driver.findElementsByXPath("//div[@class='MuiCardContent-root css-1qw96cp']");
    ...
    public Boolean verifyCartContents(List<String> expectedCartContents) {
        try {
            ...
            //div[@class='cart MuiBox-root css-0']
            //div[@class='MuiBox-root css-zgtx0t']
