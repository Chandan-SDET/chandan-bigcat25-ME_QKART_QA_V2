...
public class Checkout {
    ...
    public Boolean addNewAddress(String addresString) {
        try {
            ...
            WebElement addnewAdd = driver.findElement(By.id("add-new-btn"));
            addnewAdd.click();
            WebElement txtare = driver.findElement(
    ...
    public Boolean selectAddress(String addressToSelect) {
        try {
             ...
             */
            List<WebElement> Address = driver.findElements(
                    By.xpath("//div[@Class='address-item not-selected MuiBox-root css-0']/div/p"));
            for (WebElement addr : Address) {
                String actaddr = addr.getText();
                if (actaddr.equals(addressToSelect)) {
                    addr.click();
                    return true;
                }
            }
    ...
    public Boolean verifyInsufficientBalanceMessage() {
        try {
            // TODO: CRIO_TASK_MODULE_TEST_AUTOMATION - TEST CASE 07: MILESTONE 6
                WebElement pop= driver.findElement(By.id("notistack-snackbar"));
                 //Boolean popshow= pop.isDisplayed();
                 String msg= pop.getText();
